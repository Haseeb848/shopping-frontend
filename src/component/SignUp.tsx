...
'Access-Control-Allow-Headers': '*' },
  ...
  return (
    <Grid container direction="column" alignItems="center" justifyContent="center" spacing={2}>
      ...
      <Grid item>
        <TextField name="firstName" label="First Name" variant="outlined" onChange={handleChange} />
      </Grid>
      <Grid item>
        <TextField name="lastName" label="Last Name" variant="outlined" onChange={handleChange} />
      </Grid>
      <Grid item>
